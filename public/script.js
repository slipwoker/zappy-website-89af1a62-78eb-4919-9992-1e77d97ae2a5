document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (type === 'email' && !isValidEmail(value)) {
          ...
          if (value.length > max) {
            errorMessage = getFieldLabel(field, form) + ' must not exceed ' + max + ' characters.';
          }
        }
      }
  ...
  function clearFormErrors(form) {
    ...
    const validFields = form.querySelectorAll('.field-valid');
    validFields.forEach(function (field) {
      field.classList.remove('field-valid');
    });

    const formMessages = form.querySelectorAll('.form-success-message, .form-global-error');
    ...
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.matches && node.matches(SELECTOR)) {
          if (!node.classList.contains(ANIMATION_CLASS)) {
            if ('IntersectionObserver' in window) {
              node.classList.add(ANIMATION_CLASS);
            } else {
              node.classList.add(ANIMATION_CLASS, VISIBLE_CLASS);
            }
          }
        }
        ...
        children.forEach(function (child) {
          if (!child.classList.contains(ANIMATION_CLASS)) {
            if ('IntersectionObserver' in window) {
              child.classList.add(ANIMATION_CLASS);
            } else {
              child.classList.add(ANIMATION_CLASS, VISIBLE_CLASS);
            }
          }
        });
      });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
      ...
      "es": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL utiliza cookies para mejorar tu experiencia, analizar el uso del sitio y ayudar en nuestros esfuerzos de marketing.",
      ...
      "fr": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL utilise des cookies pour améliorer votre expérience, analyser l'utilisation du site et nous aider dans nos efforts marketing.",
      ...
      "de": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL verwendet Cookies, um Ihr Erlebnis zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingbemühungen zu unterstützen.",
      ...
      "it": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL utilizza i cookie per migliorare la tua esperienza, analizzare l'utilizzo del sito e supportare le nostre attività di marketing.",
      ...
      "pt": {
        "consentModal": {
          "title": "Usamos cookies 🍪",
          "description": "T.D GLOBAL usa cookies para melhorar sua experiência, analisar o uso do site e auxiliar em nossos esforços de marketing.",
      ...
      "nl": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL gebruikt cookies om uw ervaring te verbeteren, het sitegebruik te analyseren en onze marketinginspanningen te ondersteunen.",
      ...
      "ar": {
        "consentModal": {
          ...
          "description": "يستخدم T.D GLOBAL ملفات تعريف الارتباط لتحسين تجربتك وتحليل استخدام الموقع والمساعدة في جهودنا التسويقية.",
      ...
      "tr": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL, deneyiminizi geliştirmek, site kullanımını analiz etmek ve pazarlama çalışmalarımıza yardımcı olmak için çerezler kullanır.",
      ...
      "ru": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL использует файлы cookie для улучшения вашего опыта, анализа использования сайта и поддержки наших маркетинговых усилий.",
      ...
      "zh": {
        "consentModal": {
          "title": "我们使用 Cookie 🍪",
          "description": "T.D GLOBAL 使用 Cookie 来改善您的体验、分析网站使用情况并协助我们的营销工作。",
          "acceptAllBtn": "全部接受",
      ...
      "ja": {
        "consentModal": {
          ...
          "description": "T.D GLOBALは、お客様の体験向上、サイト利用状況の分析、マーケティング活動の支援のためにCookieを使用しています。",
          "acceptAllBtn": "すべて許可",
      ...
      "ko": {
        "consentModal": {
          "title": "쿠키를 사용합니다 🍪",
          "description": "T.D GLOBAL은(는) 경험 향상, 사이트 사용 분석 및 마케팅 활동 지원을 위해 쿠키를 사용합니다.",
          "acceptAllBtn": "모두 수락",
      ...
      "pl": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL używa plików cookie, aby poprawić Twoje wrażenia, analizować korzystanie z witryny i wspierać nasze działania marketingowe.",
      ...
      "uk": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL використовує файли cookie для покращення вашого досвіду, аналізу використання сайту та підтримки наших маркетингових зусиль.",
      ...
      "ro": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL folosește cookie-uri pentru a vă îmbunătăți experiența, a analiza utilizarea site-ului și a sprijini eforturile noastre de marketing.",
      ...
      "bg": {
        "consentModal": {
          ...
          "description": "T.D GLOBAL използва бисквитки, за да подобри вашето изживяване, да анализира използването на сайта и да подпомогне маркетинговите ни усилия.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '89af1a62-78eb-4919-9992-1e77d97ae2a5',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '89af1a62-78eb-4919-9992-1e77d97ae2a5';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to +972505554912 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '89af1a62-78eb-4919-9992-1e77d97ae2a5';
